...
export class TemaService {
  ...
  putTema(tema: Tema): Observable<Tema>{
    return this.http.put<Tema>("https://eduardoblogpessoal.herokuapp.com/tema", tema, this.token)
  }
  deleteTema(id: number){
    return this.http.delete(`https://eduardoblogpessoal.herokuapp.com/tema/${id}`, this.token)
  }
}
